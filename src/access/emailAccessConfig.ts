...
export const emailAccessConfig = {
	...
	sundaySchool: ['aejmcclelland@googlemail.com'],
	scouting: ['aejmcclelland@googlemail.com'],
	scouts: ['aejmcclelland@googelmail.com'],
	rainbows: ['aejmcclelland@googlemail.com'],
	brownies: ['aaejmcclelland@googlemail.com'],
