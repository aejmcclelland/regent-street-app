...
export const ThursdayClub: CollectionConfig = {
	slug: 'thursdayClub',
	labels: {
		singular: 'thursdayClub',
		plural: 'thursdayClubs',
	},
	admin: {
		useAsTitle: 'name',
		hidden: ({ user }) =>
			!shouldShowAdminCollection('thursdayClub', user?.email, user?.roles),
	},
	access: {
		...singletonAccess('thursdayClub', emailAccessConfig.firstFriends),
	},
	fields: [
		{
			name: 'name',
